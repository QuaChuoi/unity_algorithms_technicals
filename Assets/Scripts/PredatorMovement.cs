...
//     private BoidMovements chaseTarget;
...
//     private List<BoidMovements> TargetInRange()
//     {
...
//     private Vector2 ForwardTarget(List<BoidMovements> targetsInRange)
//     {
...
//     private void ClosestTarget(List<BoidMovements> targetsInRange)
//     {
//         if (targetsInRange == null || targetsInRange.Count == 0)
//         {
//             return;
//         }
//         BoidMovements closestTarget = targetsInRange[0];
...
//     private IEnumerator RunClosestTarget(List<BoidMovements> targetsInRange)
//     {
